	...
	<div class="row">
		...
		<div class="col-md-10" ">
            ...
            <asp:Panel ID="pn_NonCheck" runat="server" Visible="False">
                ...
                &nbsp;
                <asp:Button ID="bt_Mail_Modify" runat="server" Text="移除"  style="border: 5px solid #0C2C76; color:#ECE2D0; background-color:#4A6CBB; vertical-align:middle; " 
         ...
         <script type="text/javascript">
             ...
             function confirmReset() {
                 swal({
                     ...
                     window.location.href = "Teacher_Profile.aspx";
                 });
             }
