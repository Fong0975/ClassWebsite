<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Profile.aspx.vb" Inherits="WebPage_Public_Profile" %>
  ...
  <body>
	...
	<div class="row">
		...
		<div class="col-md-10" ">
            ...
            <p>
			    ※如果你沒有輸入信箱，那麼忘記密碼時系統將無法提供密碼給你。</p>
            <p>
            ...
            <p><small>
				※ If you
			    don&#39;t enter email, you can&#39;t get your password back when you forget it.</small></p>
            <br />
                ...
                style="font-family: 微軟正黑體; font-size: 12pt; color: #333333; vertical-align: middle; border: 3px solid #666666; padding: 3px;width: 100%">
            <tr>
                <td 
                    
                    style="text-align: center; width: 5%; border-bottom-style: solid; border-bottom-width: 2px; background-color: #5E2F0F; color: #FFFFFF; border-bottom-color: #FFF7EE;" 
                    rowspan="2">
                    帳戶</td>
                <td 
                    ...
                    style="border-color: #FFF7EE; text-align: center; width: 10%; border-bottom-style: solid; border-bottom-width: 1px; background-color: #C2906E; color: #5E2F0F;">
                    帳戶資訊</td>
                <td class="style1" 
                    
                    style="padding: 5px; border-bottom-style: solid; border-bottom-width: 1px; border-color: #FFF7EE; background-color: #EDC5A9;">
                    <asp:Label ID="lb_Account_Info" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="border-color: #FFF7EE; text-align: center; width: 10%; border-bottom-style: solid; border-bottom-width: 2px; color: #5E2F0F; background-color: #C2906E;">
                    帳戶密碼</td>
                <td style="border-bottom-style: solid; border-bottom-width: 2px; border-color: #FFF7EE; background-color: #EDC5A9;">
            ...
            <tr>
                <td style="text-align: center; width: 5%; border-bottom-style: solid; border-bottom-width: 2px; background-color: #E3A2AA; color: #5A0E17; border-bottom-color: #FFF7EE;" 
                    rowspan="3">
                    資料</td>
                <td style="border-color: #FFF7EE; text-align: center; width: 10%; border-bottom-style: solid; border-bottom-width: 1px; background-color: #BA6972; color: #5A0E17;">
                    個人頭貼</td>
                <td style="padding: 8px; border-bottom-style: solid; border-bottom-width: 1px; border-color: #FFF7EE; background-color: #9A444E;">
            ...
            <tr>
                <td style="border-color: #FFF7EE; text-align: center; width: 10%; border-bottom-style: solid; border-bottom-width: 1px; background-color: #BA6972; color: #5A0E17;">
                    個人暱稱</td>
                <td style="padding: 5px; border-bottom-style: solid; border-bottom-width: 1px; border-color: #FFF7EE; background-color: #9A444E;">
                    <asp:TextBox ID="tb_User_Nickname" runat="server"  
                        placeholder = "輸入一個同學間親暱的稱呼吧！" Width="50%"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="border-color: #FFF7EE; text-align: center; width: 10%; border-bottom-style: solid; border-bottom-width: 2px; background-color: #BA6972; color: #5A0E17;">
                    出生日期</td>
                <td style="padding: 5px; border-bottom-style: solid; border-bottom-width: 2px; border-color: #FFF7EE; background-color: #9A444E;">
            ...
            <tr>
                <td style="text-align: center; width: 5%; border-bottom-style: solid; border-bottom-width: 2px; background-color: #5E2F0F; color: #FFFFFF; border-bottom-color: #FFF7EE;" 
                    rowspan="4">
                    通訊</td>
                <td style="border-color: #FFF7EE; text-align: center; width: 10%; border-bottom-style: solid; border-bottom-width: 1px; background-color: #C2906E; color: #5E2F0F;">
                    家用電話</td>
                <td style="border-bottom-style: solid; border-bottom-width: 1px; border-color: #FFF7EE; background-color: #EDC5A9;">
                    <asp:TextBox ID="tb_User_HomePhone" runat="server"  
                        placeholder = "輸入家用電話讓同學間不失聯 ex.02-1234567" Width="50%"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="border-color: #FFF7EE; text-align: center; width: 10%; border-bottom-style: solid; border-bottom-width: 1px; background-color: #C2906E; color: #5E2F0F;">
                ...
                <td style="border-bottom-style: solid; border-bottom-width: 1px; border-color: #FFF7EE; background-color: #EDC5A9;">
                   <asp:TextBox ID="tb_User_CellPhone" runat="server"  
                        placeholder = "輸入手機號碼讓連絡更方便" Width="50%"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="border-color: #FFF7EE; text-align: center; width: 10%; border-bottom-style: solid; border-bottom-width: 1px; background-color: #C2906E; color: #5E2F0F;">
                    電子信箱</td>
                <td style="border-bottom-style: solid; border-bottom-width: 1px; border-color: #FFF7EE; background-color: #EDC5A9;">
                    <asp:Button ID="bt_Mail_Modify" runat="server" Text="變更" 
                        ...
                        style="border: 5px solid #7A6563; color:#ECE2D0; background-color:#D3A588; vertical-align:middle; " 
                        PostBackUrl="~/WebPage/Student/EmailModify.aspx" />
                    <br />
                   <asp:TextBox ID="tb_User_Email" runat="server"  
                        placeholder = "按下按鈕進行信箱驗證吧！" Enabled="False" Width="50%"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="border-color: #FFF7EE; text-align: center; width: 10%; border-bottom-style: solid; border-bottom-width: 2px; color: #5E2F0F; background-color: #C2906E;">
                    通訊地址</td>
                <td style="border-bottom-style: solid; border-bottom-width: 2px; border-color: #FFF7EE; padding-left: 8px; background-color: #EDC5A9;">
            ...
            <tr >
                ...
                <td style="border-bottom-style: solid; border-bottom-width: 1px; border-color: #FFF7EE; background-color: #9A444E;">
                    &nbsp;</td>
            </tr>
            <tr>
                <td style="border-color: #808080; text-align: center; width: 10%; background-color: #BA6972; color: #5A0E17;">
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/WebPic/icon_Line.png" 
                        Width="100%" style="Max-Width:100px;" />
                </td>
                <td style="background-color: #9A444E;">
                    &nbsp;</td>
            </tr>
