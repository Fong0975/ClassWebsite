<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Forum.aspx.vb" Inherits="WebPage_Class_Member" %>
  ...
  <form id="Form1" runat="server">
	...
	<div class="row">
		...
		<div class="col-md-10">
			...
			<p>
				以下是所有在這個班級中的討論議題，也歡迎各個不同班級的你們一起加入討論！</p>
            <p>
				&nbsp;<small>There is all 
                issus in the forum of this classroom.&nbsp; Welcome everybody to comment with 
                us.</small>
			</p>
            ...
            <div style="text-align:center;">
                <asp:Button ID="bt_InsertComment" runat="server" Text="留言" Visible="False" />                
            </div>
            <asp:Image ID="Image1" runat="server" 
                ImageUrl="~/Images/WebPic/Announcement_NotCompleted.png" Width="100%" />
            <br />
